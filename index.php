    ...
    <header class="bg-dark py-5">
      <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
          <h1 class="display-4 fw-bolder">New Stock Selling Out Soon!</h1>
          <!-- <p class="lead fw-normal text-white-50 mb-0">
            With this shop hompeage template
          </p> -->
          <img
            src="assets/hero/climb.jpg"
            alt="Sale Image"
    ...
    <div class="container px-4 px-lg-5 mt-5">
        ...
        <div class="row gx-4 gx-lg-5 row-cols-1 row-cols-md-2 row-cols-xl-3 justify-content-center">
            ...
            try {
                ...
                $sql = "SELECT prodid, prodname, prodprice, image_path FROM mesa_products WHERE catid = '1' ORDER BY prodname ASC LIMIT 3";
                $stmt = $dbh->query($sql);
...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        <h2 class="text-center">Women's Outfit</h2>
        <div class="row gx-4 gx-lg-5 row-cols-1 row-cols-md-2 row-cols-xl-3 justify-content-center">
            <?php
            try {
                // Assuming '3' is the category ID for sales
                $sql = "SELECT prodid, prodname, prodprice, image_path FROM mesa_products WHERE catid = '2' ORDER BY prodname ASC LIMIT 3";
                $stmt = $dbh->query($sql);
...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        <h2 class="text-center">On Sales</h2>
        <div class="row gx-4 gx-lg-5 row-cols-1 row-cols-md-2 row-cols-xl-3 justify-content-center">
            <?php
            try {
                // Assuming '3' is the category ID for sales
                $sql = "SELECT prodid, prodname, prodprice, image_path FROM mesa_products WHERE catid = '3' ORDER BY prodname ASC LIMIT 3";
                $stmt = $dbh->query($sql);
